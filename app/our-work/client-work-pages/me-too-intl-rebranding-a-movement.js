...
export const ME_TOO_REBRANDING_A_MOVEMENT = new Project({
  ...
  project_overview: (
    <>
      #metoo exploded on social media in 2017, as a movement created to combat
      sexual violence toward women of color. That’s when the hashtag’s viral
      dominance eclipsed the true origins of this culture-shaping organization
      and the vital work it had been doing since its inception in 2006. It was
      at this point that founder, Tarana Burke, knew reclaiming their identity
      and strengthening their narrative was a must, so she turned to Outright to
      help.
      <br />
      <br />
      Mindful of the brand’s intrinsic need to be as unique and empowering as
      the communities they serve, we got to work. Black artists, activists, and
      social movements provided inspiration and a lens for crafting a brand that
      was dynamic and resilient. Rich textures, stylized photography, expressive
      typography, and an expansive color palette create a functional and nuanced
      brand system with elements that can be dialed up and down to resonate with
      audiences more deeply—whether the organization is speaking as a sanctuary
