...
export const WRI_DATA_DRIVEN_REVOLUTION = new Project({
  ...
  main_headline: <>Changing the way decision-makers change the world.</>,
  bento_top: BENTO_TOP,
  ...
  quote: (
    <>
      We’re trying to find a compelling way to visualize data across multiple
      systems into a single platform. It’s been essential having Outright and
      Graphicacy work with us hand-in-hand to figure out how to bring systems
      change to life.
    </>
  ),
  ...
  project_overview: (
    <>
      Transformational change is needed to address the world’s biggest
      environmental, economic and social issues. But creating that change
      effectively and efficiently is complex, and requires decision-makers to
      have deep knowledge and extensive understanding of all the factors at
      play. That’s where Systems Change Lab (SCL) comes in. Outright partnered
      with the nonprofit to help them create an extensive and immersive
      open-source data visualization platform that effortlessly tracks and
      distills vast amounts of information into actionable insights that can be
      prioritized to best tackle these challenges.
      <br />
      <br />
      The SCL platform includes more than 500 indicators, each representing
      hundreds or thousands of data points. And Outright designed every element
      of it. We started by immersing ourselves in the world of scientists, data
      analysts, and climate experts, gleaning insights from focus groups and
      testing to inform every aspect of our work—from the name and our initial
      design concepts (that helped secure additional grants for the platform) to
      brand identity and platform development with our data visualization
      partner, Graphicacy. Post-launch, Outright continues to provide web
      support and enhancements for SCL.
    </>
  ),
