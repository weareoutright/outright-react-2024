...
export const MODEV_AI_EVENT_FOR_A_NEW_ERA = new Project({
  ...
  project_overview: (
    <>
      Unless you live under a rock (that doesn’t have wi-fi), it’s hard not to
      see the ways AI is bleeding into every aspect of our lives. But how do we
      make sure all facets of AI collaborate and blend together in ways that
      change our world for the better? Enter GNRT.AI. An event created to
      support and accelerate global innovations in augmented-intelligence. To do
      that well, the GNRT (pronounced “generate”) brand experience had to live
      up to the hype surrounding this technology. That’s when Modev (the creator
      of the event) tagged Outright to make it happen.
      <br />
      <br />
      After our team imagined GNRT’s original squid-inspired mark, we stretched
      our tentacles further into the deep-sea metaphor, to accentuate the innate
      immersive fluidity of the brand, while making it feel even more
      intelligent and alive. Continuous motion—both subtle and kinetic—ushers
      attendees through every aspect of the event, from registration to the
      final demo. Abstract ink flows into bold typography and custom
      AI-generated portraits (meant to work across digital touch screens, edgy
      swag, animated speaker backgrounds, and more) to visually represent and
      inspire the ways augmented intelligence is weaving its way into every
      aspect of our lives.
    </>
  ),
  prev_page: async () =>
